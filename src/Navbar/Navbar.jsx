            ...
            <div className="navbar w-[95%] md:max-w-7xl mx-auto">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[2] p-6 gap-y-4 shadow bg-base-100 rounded-box w-56 text-black">
                        <Link to="/">Home</Link>
                            ...
                            <button className={`text-start ${!user ? "hidden" : ""}`} onClick={handleLogOut}>Log Out</button>
                        </ul>
                    </div>
