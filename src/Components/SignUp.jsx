        ...
        createAccount(email, password)
            .then(result => {
                ...
                userUpdate(name, photoURL)
                    ...
                    axios.post("https://electro-evo-server.vercel.app/jwt", user, {withCredentials:true})  
                  .then(data => {
                            ...
                            <div className="container flex flex-col items-center justify-center px-6 mx-auto">
                                <form onSubmit={handleSignUp} className="w-full max-w-md">
                                    ...
                                    <div className="relative flex items-center mt-8">
                                        ...
                                        <input type="email"
                                            name="email"
                                            className="w-full rounded-3xl py-3 bg-[#135D66]  border-2 text-white px-11 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                                            placeholder="Email"
                                            required />
                                    </div>
                                    {/* password */}
